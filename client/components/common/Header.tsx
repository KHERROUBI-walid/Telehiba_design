      ...
      <div className="flex items-center gap-3">
        ...
        {onMenuToggle && (
          <div className="relative" ref={menuRef}>
            ...
            {showMenu && (
              <div 
                className="fixed right-4 top-20 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/50 w-52 py-3 z-[9999] animate-in slide-in-from-top-5 duration-300"
                role="menu"
